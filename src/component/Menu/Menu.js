      ...
      <div className="d-flex flex-column m-4 gap-5 mt-5">
        ...
        <div className="dropdown icons ">
          ...
          <div className="dropdown-menu  mobile">
            ...
            <Link className="dropdown-item" to="/category/skincare">
              Skincare
            </Link>
            <Link className="dropdown-item" to="/category/fragrances">
              Perfume
            </Link>
            <Link className="dropdown-item" to="/category/home-decoration">
              Home-Decoration
            </Link>
            <Link className="dropdown-item" to="/category/groceries">
              Groceries
            </Link>
          </div>
        </div>
